...
PRS_CLOSE_WARNING = """
Hi humans :wave: - this PR hasn't had any new commits for approximately 5
months. Of course, in this day and age we all have way too much on our plates
(especially me!) but in the interest on making sure that we don't keep pull
requests open if they are no longer relevant, **I plan to close this in a month if
the pull request doesn't have any new commits by then.**

If you **really** want to keep this PR open beyond because it needs more
discussion, then you can get a maintainer to add the **keep-open** label,
but please only use this in rare cases. A better solution if you don't agree to
merge this now is to close this and open a new issue to remind ourselves this
should be done (for example if this PR is the wrong approach).

In any case, I will close this within a month unless there is a new commit
or the **keep-open** label has been added. Thanks!

*If you believe I commented on this issue incorrectly, please report this at
https://github.com/astropy/astropy-bot/issues*
"""
...
closed this issue incorrectly, please report this at
https://github.com/astropy/astropy-bot/issues*
"""
